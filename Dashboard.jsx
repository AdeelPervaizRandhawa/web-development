  ...
  return (
    <div className="dashboard p-6 bg-gradient-to-r from-blue-100 to-purple-100 min-h-screen">
      ...
      <header className="mb-6 text-center">
        <h1 className="text-5xl font-extrabold text-purple-700">Personal Finance Tracking APPLICATION Using React js and Node</h1>
        <p className="text-lg text-gray-600 mt-2">Track the income and  expenses</p>
